const board = {
    id: "1",
    name: "Bảng 1",
    members: [{ userId: "1", role: "admin", avatar: "" }],
    lists: [
        {
            id: "1",
            name: "List 1",
            cards: [
                {
                    ...
                    dueDate: "2017-08-29T10:16:34.000Z",
                    comment: [
                        {
                            userId: "1",
                            content: "Done rồi nha",
                            date: "2017-08-29T10:16:34.000Z",
                        },
                    ],
                    info: {
                        backgroundImage: "",
    ...
    activities: [
        {
            ...
            cardId: "2837273da9b93dd84243s0f9",
            listId: "56027cf5a2ca3839a5d36103",
            createdAt: "now",
        },
        {
            id: "2",
    ...
    labels: [{ id: "1", name: "High Priority", class: "bg-red text-white" }],
};
...
const getState = {
    ...
    login: {
        ...
        findId: {
            ...
            fullname: "Ngoc Hai",
            contact:
                '[{"id":6,"status":"receive","unread":"2"},{"id":3,"status":"friend","unread":"2"},{"id":4,"status":"friend","unread":"2"},{"id":5,"status":"friend","unread":"2"}]',
            conversations:
                '[{"chatId":"6f3696b1","contactId":6,"lastMessageTime":""},{"chatId":"1","contactId":"3","lastMessageTime":"2017-06-12T02:10:18.931Z"},{"chatId":"2","contactId":"4","lastMessageTime":"2017-02-18T10:30:18.931Z"},{"chatId":"3","contactId":"5","lastMessageTime":"2017-03-18T12:30:18.931Z"}]',
            info: '{"address":"","gender":" ","avatar":"http://localhost:4000/storage/jpg/bo-hinh-nen-chat-luong-cao-2.jpg","phoneNumber":"","birthday":"2021-08-03"}',
        },
    },
    chatPanel: {
        state: true,
        user: {
            ...
            info: {
                address: "",
                gender: " ",
                avatar: "http://localhost:4000/storage/jpg/bo-hinh-nen-chat-luong-cao-2.jpg",
                phoneNumber: "",
                birthday: "2021-08-03",
            },
        },
            ...
            dialog: [
                {
                    who: 2,
                    message: "test",
                    time: "2021-08-05T15:58:01.690Z",
                },
                {
                    who: 2,
                    message: "test",
                    time: "2021-08-05T15:59:12.373Z",
                },
                {
                    who: 2,
                    message: "test 2",
                    time: "2021-08-05T16:01:08.675Z",
                },
                {
                    who: 2,
                    message: "test asd",
                    time: "2021-08-05T16:03:07.176Z",
                },
            ],
        },
    },
