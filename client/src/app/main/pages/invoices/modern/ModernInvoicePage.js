        ...
        <div>
            {invoice && (
                ...
                <FuseAnimate duration={600}>
                    ...
                    <Card style={{ shadow: '1px 3px 25px black' }} className="mx-auto w-xl print:w-full print:shadow-none">
                            ...
                            <div className="flex flex-row justify-between items-start">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <div className="flex items-center mb-80 print:mb-0">
                                        ...
                                        <img className="w-160 print:w-60" src="assets/images/logos/hypertask.svg" alt="logo"/>
                                    ...
                                    <div className="flex items-center">
                                        <div className="flex justify-end items-center w-160 print:w-60">
                                            <Typography variant="h5" className="font-light print:text-16" color="textSecondary">USER INFORMATION</Typography>
                                        </div>
                            ...
                            <div className="mt-96 print:mt-0 print:px-16">
                                ...
                                <div className="flex">
                                    ...
                                    <div className="flex-shrink-0 mr-24">
                                        <img className="w-32" src="assets/images/logos/hypertask.svg" alt="logo"/>
                                    </div>
